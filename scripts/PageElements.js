const placeVnListInSearch = (data, explicit) => {
...
const placeVnList = (data, explicit) => {
  /*title, image, image.sexual, length, developers?*/
...
const showExplicit = (currentVnList, currentVnSearchList, explicit) => {
  explicit = true;

  if (currentVnList != undefined) {
    placeVnList(currentVnList, explicit);
  }
  if (currentVnSearchList != undefined) {
    placeVnListInSearch(currentVnSearchList, explicit);
  }

  return explicit;
};

const hideExplicit = (currentVnList, currentVnSearchList, explicit) => {
  explicit = false;
  if (currentVnList != undefined) placeVnList(currentVnList, explicit);
  if (currentVnSearchList != undefined)
    placeVnListInSearch(currentVnSearchList, explicit);
